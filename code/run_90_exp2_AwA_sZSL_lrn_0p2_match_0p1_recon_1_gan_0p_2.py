...
def main(_):
	...
	log_directory = "./log/log_90_exp2_AwA_sZSL_lrn_0p2_match_0p1_recon_1_gan_0p_2"
	log_file_name_head = log_directory + "/log"
	if not os.path.exists(log_directory):
		os.makedirs(log_directory)

	load_model_directory = "./log/log_90_exp2_AwA_sZSL_lrn_0p2_match_0p1_recon_1_gan_0p"
