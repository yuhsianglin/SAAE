...
log_file = open("./log/log_23_lrn_0p02_data_1202_match_1_adagrad.txt")
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.savefig('./log/fig_23_lrn_0p02_data_1202_match_1_adagrad.pdf')
...
plt.savefig('./log/fig_23_lrn_0p02_data_1202_match_1_adagrad_accuracy.pdf')
