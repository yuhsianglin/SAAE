...
def main(_):
	...
	train_file_name = "../AwA/xTrain.npy"
	test_file_name = "../AwA/xTest.npy"

	train_label_file_name = "../AwA/yTrain.npy"
	test_label_file_name = "../AwA/yTest_relabeled.npy"

	train_attr_file_name = "../AwA/sTrain.npy"
	test_attr_file_name = "../AwA/sTest.npy"

	log_directory = "./log/log_56_sae2_AwA_0_lrn_0p2_match_100"
