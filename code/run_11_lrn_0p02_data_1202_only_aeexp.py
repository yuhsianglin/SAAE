...
def main(_):
	...
	log_file_name_head = "./log/log_11_lrn_0p02_data_1202_only_aeexp"
	...
	aeexp_machine = aeexp.aeexp(input_dim, hid_dim, class_num, d1, lrn_rate, momentum, batch_size_train, epoch_max, reg_lambda, train_file_name, val_file_name, test_file_name, log_file_name_head, gaus_train_file_name, gaus_val_file_name, gaus_test_file_name, attr_file_name, write_model_log_period)
